          ...
          <div className="navbar-head">
            ...
            <ul className="navbar-nav-head">
              <li className="nav-item-head">
                <a href="#home" className="nav-link-head">
                  Home
                </a>
              </li>
              <li className="nav-item-head">
                <a href="#about" className="nav-link-head">
                  About
                </a>
              </li>
              <li className="nav-item-head">
                <a href="#services" className="nav-link-head">
                  Services
                </a>
              </li>
              <li className="nav-item-head">
                <a href="#skills" className="nav-link-head">
                  Skills
                </a>
              </li>
              <li className="nav-item-head">
                <a href="#projects" className="nav-link-head">
                  Projects
                </a>
              </li>
              <li className="nav-item-head">
                <a href="#contact" className="nav-link-head">
                  Contact
                </a>
              </li>
            </ul>
